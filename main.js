...
var maze = function (X, Y) {
    ...
    this.draw_canvas = function (id) {
            ...
            for (var i = 0; i < 2 * this.N + 1; i++) {
                for (var j = 0; j < 2 * this.M + 1; j++) {
                    if (this.Board[i][j] != ' '){//} && this.Board[i][j] != '&') {
                        this.ctx.fillStyle = "#3b0954"; //maze wall color
        ...
        //    console.log(temp)
            this.Board[x[0]][x[1]] = '&'
            this.ctx.fillStyle = "#c4192a"; //red dot when its not moving
    ...
    this.moveclear = function (a,b) {
        var scale = this.S;
        this.ctx = this.canvas.getContext('2d');
        this.ctx.fillStyle = "#e27158"; //trail being "mapped out"
    ...
    this.move =  function (a,b) {
        var scale = this.S;
        this.ctx = this.canvas.getContext('2d');
        this.ctx.fillStyle = "#c4192a";//red dot when it moves
        this.ctx.fillRect(scale * a, scale * b, scale, scale);
        this.Board[a][b] = '&'
    }
